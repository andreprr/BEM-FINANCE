  ...
  <div class="container">
    <div class="login-box">
      ...
      <center>
        ...
        <h3><b>BEM-IM FINANCE REPORT</b></h3>
      ...
      <div class="login-box-body">
        ...
        <div class="text-center"> <img src="/gambar/user/photo.jpg" style="max-width:30%;" alt="BEM">
          <br>

          <span style="color: Black;">
            <center>
              <h4><B>BEM-IM Finance Apps</B></h4>
            </center>
          </span></p>
    ...
    <span style="color: white;">
      <center>
        <h5>copyright 2024 @RazerFear</h5>
      </center>
    </span></p>
